...
if __name__ == "__main__":
    ...
    # --- PPO ---
    model = PPO.load("models/ppo_clash_final2", env=env, device="mps")
    model.learn(total_timesteps=3_000_000, progress_bar=True, reset_num_timesteps=False,
                callback=[checkpoint_cb, eval_cb])
    model.save("models/ppo_clash_final3")
